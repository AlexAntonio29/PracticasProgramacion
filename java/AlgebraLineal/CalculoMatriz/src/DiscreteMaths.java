...
public class DiscreteMaths {
    ...
    //segundo metodo para obtener matriz adjunta
    public BigDecimal[][] getMatrizAdjunta2(BigDecimal[][] x) {
        int n = x.length;
        BigDecimal[][] matrizAdjunta = new BigDecimal[n][n];
        int p = (1);
    ...
    public BigDecimal getDeterminante2(BigDecimal[][] m1, BigDecimal[][] m2){
        BigDecimal mult;
        BigDecimal determinante = BigDecimal.ZERO;

        for (int i=0;i<m1.length;i++){
                mult=m1[0][i].multiply(m2[0][i]);
            determinante=determinante.add(mult);
        }
